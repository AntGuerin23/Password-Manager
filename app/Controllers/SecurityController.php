...
abstract class SecurityController extends ZephyrusBaseController
{
    ...
    public function before(): ?Response
    {
        ...
        try {
             ...
             * The impact value represents the severity of the attempt. Be careful about the action chosen to handle
             * such case as there may have false positive for legitimate clients. That is why there are no default
             * action.
             */
            if ($exception->getImpact() >= 3) {
